...
const Hero = () => {
  return (
    <div className='w-full  pt-[5em] flex flex-col px-5 items-center md:max-w-[1400px] '>
        <div className=''> 
            ...
            <img className='pb-5 object-cover w-full  block rounded' src={HeroImage} alt="hero" />
        </div>
          ...
          <div className='max-w-[400px] '>
              <form action="">
                  ...
                  <div className='flex relative'>
                    <input className=' rounded-[.8rem] w-[15em]  border  p-2 px-7 mt-2 bg-[#F2F2F2]' type="email" id='email' placeholder='Email' />
